...
**Live Repository:** [https://github.com/yourusername/tshidis-spaza](https://github.com/yourusername/tshidis-spaza)
...
#### JavaScript Functionality (2026-06-02)

**Form Handling:**
- Created `js/main.js` with validation for both catering and delivery forms
- Added real-time feedback (input fields turn green when valid)
- Friendly error messages in local South African language

**Validation Rules:**
- Name: minimum 3 characters
- Phone number: 10-digit SA format
- Event date: cannot be in the past
- Number of people: between 1 and 500
- Address: minimum 10 characters with Diepkloof check
- Items: minimum 5 characters with specific details

**User Experience:**
- Success and error messages appear at top of forms
- Messages auto-disappear after 5-8 seconds
...
- MDN Web Docs. (2026). *Form validation*. Available at: https://developer.mozilla.org/en-US/docs/Learn/Forms/Form_validation (Accessed: 2 June 2026)
- MDN Web Docs. (2026). *DOM manipulation*. Available at: https://developer.mozilla.org/en-US/docs/Web/API/Document_Object_Model (Accessed: 2 June 2026)
